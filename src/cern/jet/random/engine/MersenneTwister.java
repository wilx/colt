 ...
 * @param seed should not be 0, in such a case <tt>MersenneTwister.DEFAULT_SEED</tt> is silently substituted.
 */
 ...
 * @param seed should not be 0, in such a case <tt>MersenneTwister.DEFAULT_SEED</tt> is substituted.
 */
protected void setSeed(int seed) {
	...
	for (mti=1; mti<N; mti++) {
		//if (mti<10) System.out.println(mt[mti-1] +":"+ 69069 * mt[mti-1] +":"+ ((69069 * mt[mti-1]) & 0xffffffff));
