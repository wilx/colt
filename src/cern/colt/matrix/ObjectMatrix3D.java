...
For further information, see {@link cern.colt.matrix.objectalgo.Sorting#quickSort(ObjectMatrix3D,int,int)}.
...
public ObjectMatrix3D viewSorted(int row, int column) {
	return cern.colt.matrix.objectalgo.Sorting.quickSort(this,row,column);
}
/**
