...
final public class Inspection     
{
   ...
   */
  public static void for_each(byte[] array, int first, int last,
			      VoidFunction f)
    {
      while(first < last)
	f.apply(array[first++]);
   ...
   */
  public static int adjacent_find(byte[] array, int first, int last)
    {
      int next = first;
      while (++next < last) {
   ...
   *                 element exists.
   */
  public static int find(byte[] array, int first, int last, byte x)
    {
   ...
   *                 element exists.
   */
  public static int find_not(byte[] array, int first, int last, byte x)
    {
      while (first < last && x == array[first])
	++first;
      return first;
   ...
   *                 element exists.
   */
  public static int find_if(byte[] array, int first, int last, 
			    Predicate p)
    {
   ...
   */
  public static int find_if_not(byte[] array, int first, int last, 
			      Predicate p)
    {
      while (first < last && p.apply(array[first]))
	++first;
   ...
   */
  public static int count_if(byte[] array, int first, int last, 
			    Predicate p)
    {
      int counter = 0;
      while (first < last) 
   ...
   */
  public static int count_if_not(byte[] array, int first, int last, 
				 Predicate p)
    {
      int counter = 0;
      while (first < last) 
   ...
   */
  public static int mismatch(byte[] array1, byte[] array2,
   ...
   *                 index exists.
   */
  public static int search(byte[] array1, byte[] array2,
