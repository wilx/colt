...
public final class Sorting
{
   ...
   */
  public static void sort(byte[] array, int first, int last)
    { 
   ...
   * @see Sorting#sort
   */
  public static void insertion_sort(byte[] array, int first, int last)
    {
      for (int current = first; ++current < last; ) { 
	byte tmp = array[current];
	int i = current;
	for (byte tmp1 = array[i - 1]; tmp < tmp1; 
	     tmp1 = array[--i - 1] ) {
	  array[i] = tmp1;
	  if (first == i - 1) {
	    --i;
  ...
  private  static int quickPartition(byte[] array, int first, int last)
    {
      byte f = array[first];
      byte l = array[last - 1];
      byte pivot = array[first + (last - first) / 2];
  ...
  private static void qsortLoop(byte[] array, int first, int last)
    {
   ...
   * @see Sorting#sort
   */
  public static void stable_sort(byte[] array, int first, int last)
    {
   ...
   * @see Sorting#sort
   */   
  public static void partial_sort(byte[] array, int first, int middle, 
				  int last)
    {
   ...
   * @see Sorting#partial_sort
   */
  public static int partial_sort_copy(byte[] source, byte[] destination,
				      int first, int last,
   ...
   * @param last        One past the end of the range.
   */
  public static void nth_element(byte[] array, int first, int nth, 
				 int last)
    {
      while (last - first > 3) {
	int cut = quickPartition(array, first, last);
   ...
   */
  public static int lower_bound(byte[] array, int first, int last,
				byte x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#binary_search
   */
  public static int upper_bound(byte[] array, int first, int last,
				byte x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#binary_search
   */
  public static Range equal_range(byte[] array, int first, int last,
				  byte x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#equal_range
   */
  public static boolean binary_search(byte[] array, int first, int last, 
				      byte x)
    {
   ...
   */
  public static int merge(byte[] source1, byte[] source2, byte[] dest,
   ...
   */
  public static boolean includes(byte[] array1, byte[] array2,
				 int first1, int last1, int first2, int last2)
    {
      while (first1 < last1 && first2 < last2) {
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_union(byte[] source1, byte[] source2,
			      byte[] destination,
			      int first1, int last1, int first2, int last2,
			      int to)
    {
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_intersection(byte[] source1, byte[] source2,
				     byte[] destination,
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_difference(byte[] source1, byte[] source2,
				   byte[] destination,
				   int first1, int last1,
				   int first2, int last2,
				   int to)
   ...
   */
  public static void push_heap(byte[] array, int first, int last)
    {
   ...
   * @see Sorting#make_heap
   */
  private static void adjust_heap(byte[] array,
   ...
   * @see Sorting#make_heap
   */
  public static void pop_heap(byte[] array, int first, int last)
    {
      if (last - first < 2) return;
      byte tmp = array[--last];
   ...
   */
  public static void make_heap(byte[] array, int first, int last)
    {
      if (last - first < 2) return;
   ...
   * @see Sorting#make_heap
   */
  public static void sort_heap(byte[] array, int first, int last)
    {
      while (last - first > 1) {
	byte tmp = array[--last];
	array[last] = array[first];
   ...
   */
  public static int max_element(byte[] array, int first, int last)
    {
   ...
   */
  public static int min_element(byte[] array, int first, int last)
    {
      if (first >= last) return last;
   ...
   */
  public static boolean next_permutation(byte[] array, int first, int last)
    {
      if (last - first < 2)
	return false;
 ...
 /** 
   ...
   */
  public static boolean prev_permutation(byte[] array, int first, int last)
    {
      if (last - first < 2)
	return false;
