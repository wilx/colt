...
public final class Sorting
{
   ...
   */
  public static void sort(char[] array, int first, int last)
    { 
   ...
   * @see Sorting#sort
   */
  public static void insertion_sort(char[] array, int first, int last)
    {
      for (int current = first; ++current < last; ) { 
	char tmp = array[current];
	int i = current;
	for (char tmp1 = array[i - 1]; tmp < tmp1; 
	     tmp1 = array[--i - 1] ) {
	  array[i] = tmp1;
	  if (first == i - 1) {
	    --i;
  ...
  private  static int quickPartition(char[] array, int first, int last)
    {
      char f = array[first];
      char l = array[last - 1];
      char pivot = array[first + (last - first) / 2];
  ...
  private static void qsortLoop(char[] array, int first, int last)
    {
   ...
   * @see Sorting#sort
   */
  public static void stable_sort(char[] array, int first, int last)
    {
   ...
   * @see Sorting#sort
   */   
  public static void partial_sort(char[] array, int first, int middle, 
				  int last)
    {
   ...
   * @see Sorting#sort
   */   
  public static void partial_sort(char[] array,
   ...
   * @see Sorting#partial_sort
   */
  public static int partial_sort_copy(char[] source, char[] destination,
				      int first, int last,
   ...
   * @param last        One past the end of the range.
   */
  public static void nth_element(char[] array, int first, int nth, 
				 int last)
    {
      while (last - first > 3) {
	int cut = quickPartition(array, first, last);
   ...
   * @param comp        Comparison function.
   */
  public static void nth_element(char[] array,
   ...
   */
  public static int lower_bound(char[] array, int first, int last,
				char x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#binary_search
   */
  public static int upper_bound(char[] array, int first, int last,
				char x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#binary_search
   */
  public static Range equal_range(char[] array, int first, int last,
				  char x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#equal_range
   */
  public static boolean binary_search(char[] array, int first, int last, 
				      char x)
    {
   ...
   */
  public static int merge(char[] source1, char[] source2, char[] dest,
   ...
   * @see Sorting#merge
   */
  public static void inplace_merge(char[] array, 
				   int first, int middle, int last)
    {
   ...
   */
  public static boolean includes(char[] array1, char[] array2,
				 int first1, int last1, int first2, int last2)
    {
      while (first1 < last1 && first2 < last2) {
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_union(char[] source1, char[] source2,
			      char[] destination,
			      int first1, int last1, int first2, int last2,
			      int to)
    {
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_intersection(char[] source1, char[] source2,
				     char[] destination,
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_difference(char[] source1, char[] source2,
				   char[] destination,
				   int first1, int last1,
				   int first2, int last2,
				   int to)
   ...
   * @see Sorting#set_difference
   */ 
  public static int set_symmetric_difference(char[] source1,
					     char[] source2,
					     char[] destination,
					     int first1, int last1,
					     int first2, int last2,
   ...
   */
  public static void push_heap(char[] array, int first, int last)
    {
   ...
   * @see Sorting#make_heap
   */
  private static void adjust_heap(char[] array,
   ...
   * @see Sorting#make_heap
   */
  public static void pop_heap(char[] array, int first, int last)
    {
      if (last - first < 2) return;
      char tmp = array[--last];
   ...
   */
  public static void make_heap(char[] array, int first, int last)
    {
      if (last - first < 2) return;
   ...
   * @see Sorting#make_heap
   */
  public static void sort_heap(char[] array, int first, int last)
    {
      while (last - first > 1) {
	char tmp = array[--last];
	array[last] = array[first];
   ...
   */
  public static int max_element(char[] array, int first, int last)
    {
   ...
   */
  public static int min_element(char[] array, int first, int last)
    {
      if (first >= last) return last;
   ...
   */
  public static boolean lexicographical_compare(char[] array1,
						char[] array2,
						int first1, int last1,
						int first2, int last2)
    {
 ...
 /** 
   ...
   */
  public static boolean prev_permutation(char[] array, int first, int last)
    {
      if (last - first < 2)
	return false;
