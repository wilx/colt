...
final public class Inspection     
{
   ...
   */
  public static void for_each(char[] array, int first, int last,
			      VoidFunction f)
    {
      while(first < last)
	f.apply(array[first++]);
   ...
   */
  public static int adjacent_find(char[] array, int first, int last)
    {
      int next = first;
      while (++next < last) {
   ...
   *                 element exists.
   */
  public static int find(char[] array, int first, int last, char x)
    {
   ...
   *                 element exists.
   */
  public static int find_not(char[] array, int first, int last, char x)
    {
      while (first < last && x == array[first])
	++first;
      return first;
   ...
   *                 element exists.
   */
  public static int find_if(char[] array, int first, int last, 
			    Predicate p)
    {
   ...
   */
  public static int find_if_not(char[] array, int first, int last, 
			      Predicate p)
    {
      while (first < last && p.apply(array[first]))
	++first;
   ...
   */
  public static int count_if(char[] array, int first, int last, 
			    Predicate p)
    {
      int counter = 0;
      while (first < last) 
   ...
   */
  public static int count_if_not(char[] array, int first, int last, 
				 Predicate p)
    {
      int counter = 0;
      while (first < last) 
   ...
   */
  public static int mismatch(char[] array1, char[] array2,
   ...
   *                 index exists.
   */
  public static int search(char[] array1, char[] array2,
