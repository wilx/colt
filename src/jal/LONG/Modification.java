...
public final class Modification
{
   ...
   */
  static public void copy(long[] source, long[] destination,
   ...
   */
  static public void swap_ranges(long[] array1, long[] array2,
				 int first1, int last1, int first2)
    {
      while (first1 < last1) {
	long tmp = array2[first2];
   ...
   *                    input range.
   */
  public static void transform(long[] source, long[] destination,
			       int first, int last, int to,
			       UnaryOperator f)
    {
      while (first < last)
   ...
   *                    input range.
   */
  public static void transform(long[] source1, long[] source2,
			       long[] destination,
   ...
   */
  public static void replace(long[] array, int first, int last,
   ...
   */
  public static void replace_if(long[] array, int first, int last,
				Predicate p, long new_value)
    {
      while (first < last) {
   ...
   * @param new_value   Value that old_value will be replaced with.
   */
  public static void replace_copy(long[] source, long[] destination,
				  int first, int last, int to,
				  long old_value, long new_value)
    {
      while (first < last) {
	long tmp = source[first++];
   ...
   * @param new_value   Value to be substituted for replaced elements.
   */
  public static void replace_copy_if(long[] source, long[] destination,
				     int first, int last, int to,
				     Predicate p, long new_value)
    {
      while (first < last) {
   ...
   */
  public static void fill(long[] array, int first, int last, 
			  long x)
    {
      while(first < last) 
	array[first++] = x;
   ...
   */
  public static void generate(long[] array, int first, int last,
			      Generator f)
    {
      while(first < last) 
	array[first++] = f.apply();
   ...
   */
  public static int remove_if(long[] array, int first, int last, 
			      long x)
    {
      int oldLast = last;
      --first;
   ...
   *                 are contained in the range <code>[first, i)</code>.
   */
  public static int stable_remove(long[] array, int first, int last, 
				  long x)
    {
   ...
   *                 are contained in the range <code>[first, i)</code>.
   */
  public static int stable_remove_if(long[] array, int first, int last, 
				     Predicate p)
    {
   ...
   *                    is <code>[to, i)</code>.
   */
  static public int remove_copy(long[] source, long[] destination,
				int first, int last, int to,
				long value)
    {
      while (first < last) {
   ...
   *                    is <code>[to, i)</code>.
   */
  static public int remove_copy_if(long[] source, long[] destination,
				   int first, int last, int to,
				   Predicate p)
    {
      while (first < last) {
   ...
   */
  public static int unique(long[] array, int first, int last)
    {
   ...
   *                    is <code>[to, i)</code>.
   */
  public static int unique_copy(long[] source, long[] destination,
				int first, int last, int to)
    {
      if (first >= last)
	return to;
   ...
   *                   is invalid.
   */
  static public void reverse(long[] array, int first, int last)
    {
      while (first < --last) {
  ...
  public static void reverse_copy(long[] array, int first, int last, int to)
    {
      while (last > first)
	array[to++] = array[--last];
    }
   ...
   */
  public static void reverse_copy(long[] source, long[] destination,
				  int first, int last, int to)
    {
      while (last > first)
   ...
   * @param last     One past the end of the range
   */
  public static void rotate(long[] array, int first, int middle, 
				 int last)
    {
   ...
   * @param to       First element of the output range
   */
  public static void rotate_copy(long[] source, long[] destination,
   ...
   */
  public static void random_shuffle(long[] array, int first, int last,
				    Random RNG)
    {
   ...
   * @see   Predicate         
   */
  public static int partition(long[] array, int first, int last, 
			      Predicate p)
    {
      --first;
      while (true) {
   ...
   * @see   Predicate         
   */
  public static int stable_partition(long[] array, int first, 
