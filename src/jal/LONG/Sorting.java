...
public final class Sorting
{
  ...
  public static void insertion_sort(long[] array, int first, int last)
	...
	long tmp = array[current];
	int i = current;
	for (long tmp1 = array[i - 1]; tmp < tmp1; 
	     tmp1 = array[--i - 1] ) {
	  array[i] = tmp1;
	  if (first == i - 1) {
	    --i;
  ...
  private  static int quickPartition(long[] array, int first, int last)
    {
      long f = array[first];
      long l = array[last - 1];
      long pivot = array[first + (last - first) / 2];
  ...
  private static void qsortLoop(long[] array, int first, int last)
    {
   ...
   * @see Sorting#sort
   */   
  public static void partial_sort(long[] array, int first, int middle, 
				  int last)
    {
   ...
   * @see Sorting#sort
   */   
  public static void partial_sort(long[] array,
   ...
   * @see Sorting#partial_sort
   */
  public static int partial_sort_copy(long[] source, long[] destination,
				      int first, int last,
   ...
   * @param last        One past the end of the range.
   */
  public static void nth_element(long[] array, int first, int nth, 
				 int last)
    {
      while (last - first > 3) {
	int cut = quickPartition(array, first, last);
   ...
   * @param comp        Comparison function.
   */
  public static void nth_element(long[] array,
   ...
   */
  public static int lower_bound(long[] array, int first, int last,
				long x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#binary_search
   */
  public static int upper_bound(long[] array, int first, int last,
				long x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#binary_search
   */
  public static Range equal_range(long[] array, int first, int last,
				  long x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#equal_range
   */
  public static boolean binary_search(long[] array, int first, int last, 
				      long x)
    {
   ...
   */
  public static int merge(long[] source1, long[] source2, long[] dest,
   ...
   * @see Sorting#merge
   */
  public static void inplace_merge(long[] array, 
				   int first, int middle, int last)
    {
   ...
   */
  public static boolean includes(long[] array1, long[] array2,
				 int first1, int last1, int first2, int last2)
    {
      while (first1 < last1 && first2 < last2) {
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_union(long[] source1, long[] source2,
			      long[] destination,
			      int first1, int last1, int first2, int last2,
			      int to)
    {
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_intersection(long[] source1, long[] source2,
				     long[] destination,
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_difference(long[] source1, long[] source2,
				   long[] destination,
				   int first1, int last1,
				   int first2, int last2,
				   int to)
   ...
   * @see Sorting#set_difference
   */ 
  public static int set_symmetric_difference(long[] source1,
					     long[] source2,
					     long[] destination,
					     int first1, int last1,
					     int first2, int last2,
   ...
   * @see Sorting#make_heap
   */
  private static void adjust_heap(long[] array,
   ...
   */
  public static boolean lexicographical_compare(long[] array1,
						long[] array2,
						int first1, int last1,
						int first2, int last2)
    {
