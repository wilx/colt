...
public final class Modification
{
   ...
   */
  static public void copy(Object[] source, Object[] destination,
   ...
   */
  static public void swap_ranges(Object[] array1, Object[] array2,
   ...
   *                    input range.
   */
  public static void transform(Object[] source1, Object[] source2,
			       Object[] destination,
   ...
   */
  public static void replace(Object[] array, int first, int last,
   ...
   */
  public static void replace_if(Object[] array, int first, int last,
				Predicate p, Object new_value)
    {
      while (first < last) {
   ...
   * @param new_value   Value that old_value will be replaced with.
   */
  public static void replace_copy(Object[] source, Object[] destination,
				  int first, int last, int to,
				  Object old_value, Object new_value)
    {
      while (first < last) {
   ...
   * @param new_value   Value to be substituted for replaced elements.
   */
  public static void replace_copy_if(Object[] source, Object[] destination,
				     int first, int last, int to,
				     Predicate p, Object new_value)
    {
      while (first < last) {
   ...
   */
  public static void fill(Object[] array, int first, int last, 
			  Object x)
    {
      while(first < last) 
	array[first++] = x;
   ...
   */
  public static void generate(Object[] array, int first, int last,
			      Generator f)
    {
      while(first < last) 
	array[first++] = f.apply();
   ...
   */
  public static int remove_if(Object[] array, int first, int last, 
			      Object x)
    {
      int oldLast = last;
      --first;
   ...
   *                 are contained in the range <code>[first, i)</code>.
   */
  public static int stable_remove(Object[] array, int first, int last, 
				  Object x)
    {
   ...
   *                 are contained in the range <code>[first, i)</code>.
   */
  public static int stable_remove_if(Object[] array, int first, int last, 
				     Predicate p)
    {
   ...
   *                    is <code>[to, i)</code>.
   */
  static public int remove_copy(Object[] source, Object[] destination,
				int first, int last, int to,
				Object value)
    {
      while (first < last) {
   ...
   *                    is <code>[to, i)</code>.
   */
  static public int remove_copy_if(Object[] source, Object[] destination,
				   int first, int last, int to,
				   Predicate p)
    {
      while (first < last) {
   ...
   *                    is <code>[to, i)</code>.
   */
  public static int unique_copy(Object[] source, Object[] destination,
				int first, int last, int to)
    {
      if (first >= last)
	return to;
   ...
   */
  public static void reverse_copy(Object[] source, Object[] destination,
				  int first, int last, int to)
    {
      while (last > first)
   ...
   * @param to       First element of the output range
   */
  public static void rotate_copy(Object[] source, Object[] destination,
   ...
   * @see   Predicate         
   */
  public static int partition(Object[] array, int first, int last, 
			      Predicate p)
    {
      --first;
      while (true) {
   ...
   * @see   Predicate         
   */
  public static int stable_partition(Object[] array, int first, 
