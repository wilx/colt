package jal.Object;
import jal.Object.VoidFunction;
...
final public class Inspection     
{
   ...
   */
  public static void for_each(Object[] array, int first, int last,
			      VoidFunction f)
    {
      while(first < last)
	f.apply(array[first++]);
   ...
   */
  public static int adjacent_find(Object[] array, int first, int last)
    {
      int next = first;
      while (++next < last) {
   ...
   *                 element exists.
   */
  public static int find(Object[] array, int first, int last, Object x)
    {
   ...
   *                 element exists.
   */
  public static int find_not(Object[] array, int first, int last, Object x)
    {
      while (first < last && x == array[first])
	++first;
      return first;
   ...
   *                 element exists.
   */
  public static int find_if(Object[] array, int first, int last, 
			    Predicate p)
    {
   ...
   */
  public static int find_if_not(Object[] array, int first, int last, 
			      Predicate p)
    {
      while (first < last && p.apply(array[first]))
	++first;
   ...
   */
  public static int count_if(Object[] array, int first, int last, 
			    Predicate p)
    {
      int counter = 0;
      while (first < last) 
   ...
   */
  public static int count_if_not(Object[] array, int first, int last, 
				 Predicate p)
    {
      int counter = 0;
      while (first < last) 
   ...
   *                 index exists.
   */
  public static int search(Object[] array1, Object[] array2,
