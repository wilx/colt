package jal.GENERIC;
import jal.GENERIC.Modification;
import jal.GENERIC.BinaryPredicate;
import jal.GENERIC.Range;
...
public final class Sorting
{
   ...
   */
  public static void sort(generic[] array, int first, int last)
    { 
   ...
   * @see Sorting#sort
   */   
  public static void partial_sort(generic[] array,
   ...
   * @see Sorting#partial_sort
   */
  public static int partial_sort_copy(generic[] source, generic[] destination,
				      int first, int last,
   ...
   * @param comp        Comparison function.
   */
  public static void nth_element(generic[] array,
   ...
   * @see Sorting#equal_range
   */
  public static boolean binary_search(generic[] array, int first, int last, 
				      generic x)
    {
   ...
   */
  public static int merge(generic[] source1, generic[] source2, generic[] dest,
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_intersection(generic[] source1, generic[] source2,
				     generic[] destination,
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_difference(generic[] source1, generic[] source2,
				   generic[] destination,
				   int first1, int last1,
				   int first2, int last2,
				   int to)
   ...
   * @see Sorting#set_difference
   */ 
  public static int set_symmetric_difference(generic[] source1,
					     generic[] source2,
					     generic[] destination,
					     int first1, int last1,
					     int first2, int last2,
   ...
   */
  public static int min_element(generic[] array, int first, int last)
    {
      if (first >= last) return last;
   ...
   */
  public static boolean lexicographical_compare(generic[] array1,
						generic[] array2,
						int first1, int last1,
						int first2, int last2)
    {
 ...
 /** 
   ...
   */
  public static boolean prev_permutation(generic[] array, int first, int last)
    {
      if (last - first < 2)
	return false;
