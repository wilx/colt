...
public final class Numeric
{
   ...
   */
  public static short accumulate(short[] array, int first, int last,
				  short init)
    {
      short acc = init;
      while (first < last)
   ...
   */
  public static short inner_product(short[] array1, short[] array2,
   ...
   */
  public static int partial_sum(short[] source, short[] dest,
   ...
   *                  <code>to + (last - first)</code>.
   */
  public static int adjacent_difference(short[] source, short[] dest,
					int first, int last, int to)
    {
      if (first < last) {
	dest[to] = source[first];
