...
public final class Modification
{
   ...
   */
  static public void copy(short[] source, short[] destination,
   ...
   */
  static public void swap_ranges(short[] array1, short[] array2,
				 int first1, int last1, int first2)
    {
      while (first1 < last1) {
	short tmp = array2[first2];
   ...
   *                    input range.
   */
  public static void transform(short[] source, short[] destination,
			       int first, int last, int to,
			       UnaryOperator f)
    {
      while (first < last)
   ...
   *                    input range.
   */
  public static void transform(short[] source1, short[] source2,
			       short[] destination,
   ...
   */
  public static void replace(short[] array, int first, int last,
   ...
   */
  public static void replace_if(short[] array, int first, int last,
				Predicate p, short new_value)
    {
      while (first < last) {
   ...
   * @param new_value   Value that old_value will be replaced with.
   */
  public static void replace_copy(short[] source, short[] destination,
				  int first, int last, int to,
				  short old_value, short new_value)
    {
      while (first < last) {
	short tmp = source[first++];
   ...
   * @param new_value   Value to be substituted for replaced elements.
   */
  public static void replace_copy_if(short[] source, short[] destination,
				     int first, int last, int to,
				     Predicate p, short new_value)
    {
      while (first < last) {
   ...
   */
  public static void fill(short[] array, int first, int last, 
			  short x)
    {
      while(first < last) 
	array[first++] = x;
   ...
   */
  public static void generate(short[] array, int first, int last,
			      Generator f)
    {
      while(first < last) 
	array[first++] = f.apply();
   ...
   */
  public static int remove_if(short[] array, int first, int last, 
			      short x)
    {
      int oldLast = last;
      --first;
   ...
   *                 are contained in the range <code>[first, i)</code>.
   */
  public static int stable_remove(short[] array, int first, int last, 
				  short x)
    {
   ...
   *                 are contained in the range <code>[first, i)</code>.
   */
  public static int stable_remove_if(short[] array, int first, int last, 
				     Predicate p)
    {
   ...
   *                    is <code>[to, i)</code>.
   */
  static public int remove_copy(short[] source, short[] destination,
				int first, int last, int to,
				short value)
    {
      while (first < last) {
   ...
   *                    is <code>[to, i)</code>.
   */
  static public int remove_copy_if(short[] source, short[] destination,
				   int first, int last, int to,
				   Predicate p)
    {
      while (first < last) {
   ...
   */
  public static int unique(short[] array, int first, int last)
    {
   ...
   *                    is <code>[to, i)</code>.
   */
  public static int unique_copy(short[] source, short[] destination,
				int first, int last, int to)
    {
      if (first >= last)
	return to;
   ...
   *                   is invalid.
   */
  static public void reverse(short[] array, int first, int last)
    {
      while (first < --last) {
  ...
  public static void reverse_copy(short[] array, int first, int last, int to)
    {
      while (last > first)
	array[to++] = array[--last];
    }
   ...
   */
  public static void reverse_copy(short[] source, short[] destination,
				  int first, int last, int to)
    {
      while (last > first)
   ...
   * @param last     One past the end of the range
   */
  public static void rotate(short[] array, int first, int middle, 
				 int last)
    {
   ...
   * @param to       First element of the output range
   */
  public static void rotate_copy(short[] source, short[] destination,
   ...
   */
  public static void random_shuffle(short[] array, int first, int last,
				    Random RNG)
    {
      for (int i = first + 1; i < last; ++i) {
	int randomPlace =  Math.abs(RNG.nextInt()) % 
	  ((i - first) + 1);
	short tmp = array[randomPlace];
   ...
   * @see   Predicate         
   */
  public static int partition(short[] array, int first, int last, 
			      Predicate p)
    {
      --first;
      while (true) {
   ...
   * @see   Predicate         
   */
  public static int stable_partition(short[] array, int first, 
