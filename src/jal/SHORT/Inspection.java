...
final public class Inspection     
{
   ...
   */
  public static void for_each(short[] array, int first, int last,
			      VoidFunction f)
    {
      while(first < last)
	f.apply(array[first++]);
   ...
   */
  public static int adjacent_find(short[] array, int first, int last)
    {
      int next = first;
      while (++next < last) {
   ...
   *                 element exists.
   */
  public static int find(short[] array, int first, int last, short x)
    {
   ...
   *                 element exists.
   */
  public static int find_not(short[] array, int first, int last, short x)
    {
      while (first < last && x == array[first])
	++first;
      return first;
   ...
   *                 element exists.
   */
  public static int find_if(short[] array, int first, int last, 
			    Predicate p)
    {
   ...
   */
  public static int find_if_not(short[] array, int first, int last, 
			      Predicate p)
    {
      while (first < last && p.apply(array[first]))
	++first;
   ...
   */
  public static int count_if(short[] array, int first, int last, 
			    Predicate p)
    {
      int counter = 0;
      while (first < last) 
   ...
   */
  public static int count_if_not(short[] array, int first, int last, 
				 Predicate p)
    {
      int counter = 0;
      while (first < last) 
   ...
   */
  public static int mismatch(short[] array1, short[] array2,
   ...
   *                 index exists.
   */
  public static int search(short[] array1, short[] array2,
