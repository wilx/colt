...
public final class Sorting
{
   ...
   */
  public static void sort(short[] array, int first, int last)
    { 
   ...
   * @see Sorting#sort
   */
  public static void insertion_sort(short[] array, int first, int last)
    {
      for (int current = first; ++current < last; ) { 
	short tmp = array[current];
	int i = current;
	for (short tmp1 = array[i - 1]; tmp < tmp1; 
	     tmp1 = array[--i - 1] ) {
	  array[i] = tmp1;
	  if (first == i - 1) {
	    --i;
  ...
  private  static int quickPartition(short[] array, int first, int last)
    {
      short f = array[first];
      short l = array[last - 1];
      short pivot = array[first + (last - first) / 2];
  ...
  private static void qsortLoop(short[] array, int first, int last)
    {
   ...
   * @see Sorting#sort
   */
  public static void stable_sort(short[] array, int first, int last)
    {
   ...
   * @see Sorting#sort
   */   
  public static void partial_sort(short[] array, int first, int middle, 
				  int last)
    {
   ...
   * @see Sorting#sort
   */   
  public static void partial_sort(short[] array,
   ...
   * @see Sorting#partial_sort
   */
  public static int partial_sort_copy(short[] source, short[] destination,
				      int first, int last,
   ...
   * @param last        One past the end of the range.
   */
  public static void nth_element(short[] array, int first, int nth, 
				 int last)
    {
      while (last - first > 3) {
	int cut = quickPartition(array, first, last);
   ...
   * @param comp        Comparison function.
   */
  public static void nth_element(short[] array,
   ...
   */
  public static int lower_bound(short[] array, int first, int last,
				short x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#binary_search
   */
  public static int upper_bound(short[] array, int first, int last,
				short x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#binary_search
   */
  public static Range equal_range(short[] array, int first, int last,
				  short x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#equal_range
   */
  public static boolean binary_search(short[] array, int first, int last, 
				      short x)
    {
   ...
   */
  public static int merge(short[] source1, short[] source2, short[] dest,
   ...
   * @see Sorting#merge
   */
  public static void inplace_merge(short[] array, 
				   int first, int middle, int last)
    {
   ...
   */
  public static boolean includes(short[] array1, short[] array2,
				 int first1, int last1, int first2, int last2)
    {
      while (first1 < last1 && first2 < last2) {
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_union(short[] source1, short[] source2,
			      short[] destination,
			      int first1, int last1, int first2, int last2,
			      int to)
    {
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_intersection(short[] source1, short[] source2,
				     short[] destination,
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_difference(short[] source1, short[] source2,
				   short[] destination,
				   int first1, int last1,
				   int first2, int last2,
				   int to)
   ...
   * @see Sorting#set_difference
   */ 
  public static int set_symmetric_difference(short[] source1,
					     short[] source2,
					     short[] destination,
					     int first1, int last1,
					     int first2, int last2,
   ...
   */
  public static void push_heap(short[] array, int first, int last)
    {
      if (last - first < 2) return;
      short tmp = array[--last];
   ...
   * @see Sorting#make_heap
   */
  private static void adjust_heap(short[] array,
   ...
   * @see Sorting#make_heap
   */
  public static void pop_heap(short[] array, int first, int last)
    {
      if (last - first < 2) return;
      short tmp = array[--last];
   ...
   */
  public static void make_heap(short[] array, int first, int last)
    {
      if (last - first < 2) return;
   ...
   * @see Sorting#make_heap
   */
  public static void sort_heap(short[] array, int first, int last)
    {
      while (last - first > 1) {
	short tmp = array[--last];
	array[last] = array[first];
   ...
   */
  public static int max_element(short[] array, int first, int last)
    {
   ...
   */
  public static int min_element(short[] array, int first, int last)
    {
      if (first >= last) return last;
   ...
   */
  public static boolean lexicographical_compare(short[] array1,
						short[] array2,
						int first1, int last1,
						int first2, int last2)
    {
   ...
   */
  public static boolean next_permutation(short[] array, int first, int last)
    {
      if (last - first < 2)
	return false;
 ...
 /** 
   ...
   */
  public static boolean prev_permutation(short[] array, int first, int last)
    {
      if (last - first < 2)
	return false;
