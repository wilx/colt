...
public final class Sorting
{
   ...
   * @see Sorting#sort
   */
  public static void insertion_sort(int[] array, int first, int last)
    {
      for (int current = first; ++current < last; ) { 
	int tmp = array[current];
	int i = current;
	for (int tmp1 = array[i - 1]; tmp < tmp1; 
	     tmp1 = array[--i - 1] ) {
	  array[i] = tmp1;
	  if (first == i - 1) {
	    --i;
   ...
   * @see Sorting#sort
   */
  public static void stable_sort(int[] array, int first, int last)
    {
   ...
   * @see Sorting#sort
   */   
  public static void partial_sort(int[] array, int first, int middle, 
				  int last)
    {
   ...
   * @see Sorting#sort
   */   
  public static void partial_sort(int[] array,
   ...
   * @see Sorting#partial_sort
   */
  public static int partial_sort_copy(int[] source, int[] destination,
				      int first, int last,
   ...
   * @param last        One past the end of the range.
   */
  public static void nth_element(int[] array, int first, int nth, 
				 int last)
    {
      while (last - first > 3) {
	int cut = quickPartition(array, first, last);
   ...
   * @param comp        Comparison function.
   */
  public static void nth_element(int[] array,
   ...
   */
  public static int lower_bound(int[] array, int first, int last,
				int x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#binary_search
   */
  public static int upper_bound(int[] array, int first, int last,
				int x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#binary_search
   */
  public static Range equal_range(int[] array, int first, int last,
				  int x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#equal_range
   */
  public static boolean binary_search(int[] array, int first, int last, 
				      int x)
    {
   ...
   */
  public static int merge(int[] source1, int[] source2, int[] dest,
   ...
   * @see Sorting#merge
   */
  public static void inplace_merge(int[] array, 
				   int first, int middle, int last)
    {
   ...
   */
  public static boolean includes(int[] array1, int[] array2,
				 int first1, int last1, int first2, int last2)
    {
      while (first1 < last1 && first2 < last2) {
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_union(int[] source1, int[] source2,
			      int[] destination,
			      int first1, int last1, int first2, int last2,
			      int to)
    {
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_intersection(int[] source1, int[] source2,
				     int[] destination,
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_difference(int[] source1, int[] source2,
				   int[] destination,
				   int first1, int last1,
				   int first2, int last2,
				   int to)
   ...
   * @see Sorting#set_difference
   */ 
  public static int set_symmetric_difference(int[] source1,
					     int[] source2,
					     int[] destination,
					     int first1, int last1,
					     int first2, int last2,
   ...
   */
  public static void push_heap(int[] array, int first, int last)
    {
   ...
   * @see Sorting#make_heap
   */
  private static void adjust_heap(int[] array,
   ...
   * @see Sorting#make_heap
   */
  public static void pop_heap(int[] array, int first, int last)
    {
      if (last - first < 2) return;
      int tmp = array[--last];
   ...
   */
  public static void make_heap(int[] array, int first, int last)
    {
      if (last - first < 2) return;
   ...
   * @see Sorting#make_heap
   */
  public static void sort_heap(int[] array, int first, int last)
    {
      while (last - first > 1) {
	int tmp = array[--last];
	array[last] = array[first];
   ...
   */
  public static int max_element(int[] array, int first, int last)
    {
   ...
   */
  public static int min_element(int[] array, int first, int last)
    {
      if (first >= last) return last;
   ...
   */
  public static boolean lexicographical_compare(int[] array1,
						int[] array2,
						int first1, int last1,
						int first2, int last2)
    {
   ...
   */
  public static boolean next_permutation(int[] array, int first, int last)
    {
      if (last - first < 2)
	return false;
 ...
 /** 
   ...
   */
  public static boolean prev_permutation(int[] array, int first, int last)
    {
      if (last - first < 2)
	return false;
