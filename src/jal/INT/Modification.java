...
public final class Modification
{
   ...
   */
  static public void copy(int[] source, int[] destination,
   ...
   */
  static public void swap_ranges(int[] array1, int[] array2,
				 int first1, int last1, int first2)
    {
      while (first1 < last1) {
	int tmp = array2[first2];
   ...
   *                    input range.
   */
  public static void transform(int[] source, int[] destination,
			       int first, int last, int to,
			       UnaryOperator f)
    {
      while (first < last)
   ...
   *                    input range.
   */
  public static void transform(int[] source1, int[] source2,
			       int[] destination,
   ...
   */
  public static void replace(int[] array, int first, int last,
   ...
   */
  public static void replace_if(int[] array, int first, int last,
				Predicate p, int new_value)
    {
      while (first < last) {
   ...
   * @param new_value   Value that old_value will be replaced with.
   */
  public static void replace_copy(int[] source, int[] destination,
				  int first, int last, int to,
				  int old_value, int new_value)
    {
      while (first < last) {
	int tmp = source[first++];
   ...
   * @param new_value   Value to be substituted for replaced elements.
   */
  public static void replace_copy_if(int[] source, int[] destination,
				     int first, int last, int to,
				     Predicate p, int new_value)
    {
      while (first < last) {
   ...
   */
  public static void fill(int[] array, int first, int last, 
			  int x)
    {
      while(first < last) 
	array[first++] = x;
   ...
   */
  public static void generate(int[] array, int first, int last,
			      Generator f)
    {
      while(first < last) 
	array[first++] = f.apply();
   ...
   */
  public static int remove_if(int[] array, int first, int last, 
			      int x)
    {
      int oldLast = last;
      --first;
   ...
   *                 are contained in the range <code>[first, i)</code>.
   */
  public static int stable_remove(int[] array, int first, int last, 
				  int x)
    {
   ...
   *                 are contained in the range <code>[first, i)</code>.
   */
  public static int stable_remove_if(int[] array, int first, int last, 
				     Predicate p)
    {
   ...
   *                    is <code>[to, i)</code>.
   */
  static public int remove_copy(int[] source, int[] destination,
				int first, int last, int to,
				int value)
    {
      while (first < last) {
   ...
   *                    is <code>[to, i)</code>.
   */
  static public int remove_copy_if(int[] source, int[] destination,
				   int first, int last, int to,
				   Predicate p)
    {
      while (first < last) {
   ...
   */
  public static int unique(int[] array, int first, int last)
    {
   ...
   *                    is <code>[to, i)</code>.
   */
  public static int unique_copy(int[] source, int[] destination,
				int first, int last, int to)
    {
      if (first >= last)
	return to;
   ...
   *                   is invalid.
   */
  static public void reverse(int[] array, int first, int last)
    {
      while (first < --last) {
	int tmp = array[first];
	array[first++] = array[last];
  ...
  public static void reverse_copy(int[] array, int first, int last, int to)
    {
      while (last > first)
	array[to++] = array[--last];
    }
   ...
   */
  public static void reverse_copy(int[] source, int[] destination,
				  int first, int last, int to)
    {
      while (last > first)
   ...
   * @param last     One past the end of the range
   */
  public static void rotate(int[] array, int first, int middle, 
				 int last)
    {
   ...
   * @param to       First element of the output range
   */
  public static void rotate_copy(int[] source, int[] destination,
   ...
   */
  public static void random_shuffle(int[] array, int first, int last,
				    Random RNG)
    {
      for (int i = first + 1; i < last; ++i) {
	int randomPlace =  Math.abs(RNG.nextInt()) % 
	  ((i - first) + 1);
	int tmp = array[randomPlace];
   ...
   * @see   Predicate         
   */
  public static int stable_partition(int[] array, int first, 
