...
final public class Inspection     
{
   ...
   */
  public static void for_each(int[] array, int first, int last,
			      VoidFunction f)
    {
      while(first < last)
	f.apply(array[first++]);
   ...
   */
  public static int adjacent_find(int[] array, int first, int last)
    {
      int next = first;
      while (++next < last) {
   ...
   *                 element exists.
   */
  public static int find(int[] array, int first, int last, int x)
    {
   ...
   *                 element exists.
   */
  public static int find_not(int[] array, int first, int last, int x)
    {
      while (first < last && x == array[first])
	++first;
      return first;
   ...
   *                 element exists.
   */
  public static int find_if(int[] array, int first, int last, 
			    Predicate p)
    {
   ...
   */
  public static int find_if_not(int[] array, int first, int last, 
			      Predicate p)
    {
      while (first < last && p.apply(array[first]))
	++first;
   ...
   */
  public static int count_if(int[] array, int first, int last, 
			    Predicate p)
    {
      int counter = 0;
      while (first < last) 
   ...
   */
  public static int count_if_not(int[] array, int first, int last, 
				 Predicate p)
    {
      int counter = 0;
      while (first < last) 
