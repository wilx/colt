...
public final class Sorting
{
  ...
  public static void insertion_sort(float[] array, int first, int last)
	...
	float tmp = array[current];
	int i = current;
	for (float tmp1 = array[i - 1]; tmp < tmp1; 
	     tmp1 = array[--i - 1] ) {
	  array[i] = tmp1;
	  if (first == i - 1) {
	    --i;
  ...
  private  static int quickPartition(float[] array, int first, int last)
    {
      float f = array[first];
      float l = array[last - 1];
      float pivot = array[first + (last - first) / 2];
  ...
  private static void qsortLoop(float[] array, int first, int last)
    {
   ...
   * @see Sorting#sort
   */   
  public static void partial_sort(float[] array, int first, int middle, 
				  int last)
    {
   ...
   * @see Sorting#sort
   */   
  public static void partial_sort(float[] array,
   ...
   * @see Sorting#partial_sort
   */
  public static int partial_sort_copy(float[] source, float[] destination,
				      int first, int last,
   ...
   * @param last        One past the end of the range.
   */
  public static void nth_element(float[] array, int first, int nth, 
				 int last)
    {
      while (last - first > 3) {
	int cut = quickPartition(array, first, last);
   ...
   * @param comp        Comparison function.
   */
  public static void nth_element(float[] array,
   ...
   */
  public static int lower_bound(float[] array, int first, int last,
				float x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#binary_search
   */
  public static int upper_bound(float[] array, int first, int last,
				float x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#binary_search
   */
  public static Range equal_range(float[] array, int first, int last,
				  float x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#equal_range
   */
  public static boolean binary_search(float[] array, int first, int last, 
				      float x)
    {
   ...
   */
  public static int merge(float[] source1, float[] source2, float[] dest,
   ...
   * @see Sorting#merge
   */
  public static void inplace_merge(float[] array, 
				   int first, int middle, int last)
    {
   ...
   */
  public static boolean includes(float[] array1, float[] array2,
				 int first1, int last1, int first2, int last2)
    {
      while (first1 < last1 && first2 < last2) {
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_union(float[] source1, float[] source2,
			      float[] destination,
			      int first1, int last1, int first2, int last2,
			      int to)
    {
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_intersection(float[] source1, float[] source2,
				     float[] destination,
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_difference(float[] source1, float[] source2,
				   float[] destination,
				   int first1, int last1,
				   int first2, int last2,
				   int to)
   ...
   * @see Sorting#set_difference
   */ 
  public static int set_symmetric_difference(float[] source1,
					     float[] source2,
					     float[] destination,
					     int first1, int last1,
					     int first2, int last2,
   ...
   * @see Sorting#make_heap
   */
  private static void adjust_heap(float[] array,
   ...
   */
  public static boolean lexicographical_compare(float[] array1,
						float[] array2,
						int first1, int last1,
						int first2, int last2)
    {
