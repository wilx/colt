...
public final class Modification
{
   ...
   */
  static public void copy(float[] source, float[] destination,
   ...
   */
  static public void swap_ranges(float[] array1, float[] array2,
				 int first1, int last1, int first2)
    {
      while (first1 < last1) {
	float tmp = array2[first2];
   ...
   *                    input range.
   */
  public static void transform(float[] source, float[] destination,
			       int first, int last, int to,
			       UnaryOperator f)
    {
      while (first < last)
   ...
   *                    input range.
   */
  public static void transform(float[] source1, float[] source2,
			       float[] destination,
   ...
   */
  public static void replace(float[] array, int first, int last,
   ...
   */
  public static void replace_if(float[] array, int first, int last,
				Predicate p, float new_value)
    {
      while (first < last) {
   ...
   * @param new_value   Value that old_value will be replaced with.
   */
  public static void replace_copy(float[] source, float[] destination,
				  int first, int last, int to,
				  float old_value, float new_value)
    {
      while (first < last) {
	float tmp = source[first++];
   ...
   * @param new_value   Value to be substituted for replaced elements.
   */
  public static void replace_copy_if(float[] source, float[] destination,
				     int first, int last, int to,
				     Predicate p, float new_value)
    {
      while (first < last) {
   ...
   */
  public static void fill(float[] array, int first, int last, 
			  float x)
    {
      while(first < last) 
	array[first++] = x;
   ...
   */
  public static void generate(float[] array, int first, int last,
			      Generator f)
    {
      while(first < last) 
	array[first++] = f.apply();
   ...
   */
  public static int remove_if(float[] array, int first, int last, 
			      float x)
    {
      int oldLast = last;
      --first;
   ...
   *                 are contained in the range <code>[first, i)</code>.
   */
  public static int stable_remove(float[] array, int first, int last, 
				  float x)
    {
   ...
   *                 are contained in the range <code>[first, i)</code>.
   */
  public static int stable_remove_if(float[] array, int first, int last, 
				     Predicate p)
    {
   ...
   *                    is <code>[to, i)</code>.
   */
  static public int remove_copy(float[] source, float[] destination,
				int first, int last, int to,
				float value)
    {
      while (first < last) {
   ...
   *                    is <code>[to, i)</code>.
   */
  static public int remove_copy_if(float[] source, float[] destination,
				   int first, int last, int to,
				   Predicate p)
    {
      while (first < last) {
   ...
   */
  public static int unique(float[] array, int first, int last)
    {
   ...
   *                    is <code>[to, i)</code>.
   */
  public static int unique_copy(float[] source, float[] destination,
				int first, int last, int to)
    {
      if (first >= last)
	return to;
   ...
   *                   is invalid.
   */
  static public void reverse(float[] array, int first, int last)
    {
      while (first < --last) {
  ...
  public static void reverse_copy(float[] array, int first, int last, int to)
    {
      while (last > first)
	array[to++] = array[--last];
    }
   ...
   */
  public static void reverse_copy(float[] source, float[] destination,
				  int first, int last, int to)
    {
      while (last > first)
   ...
   * @param last     One past the end of the range
   */
  public static void rotate(float[] array, int first, int middle, 
				 int last)
    {
   ...
   * @param to       First element of the output range
   */
  public static void rotate_copy(float[] source, float[] destination,
   ...
   */
  public static void random_shuffle(float[] array, int first, int last,
				    Random RNG)
    {
      for (int i = first + 1; i < last; ++i) {
	int randomPlace =  Math.abs(RNG.nextInt()) % 
	  ((i - first) + 1);
	float tmp = array[randomPlace];
   ...
   * @see   Predicate         
   */
  public static int partition(float[] array, int first, int last, 
			      Predicate p)
    {
      --first;
      while (true) {
   ...
   * @see   Predicate         
   */
  public static int stable_partition(float[] array, int first, 
