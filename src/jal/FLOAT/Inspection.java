...
final public class Inspection     
{
   ...
   */
  public static void for_each(float[] array, int first, int last,
			      VoidFunction f)
    {
      while(first < last)
	f.apply(array[first++]);
   ...
   *                 element exists.
   */
  public static int find_if(float[] array, int first, int last, 
			    Predicate p)
    {
   ...
   */
  public static int find_if_not(float[] array, int first, int last, 
			      Predicate p)
    {
      while (first < last && p.apply(array[first]))
	++first;
   ...
   */
  public static int count_if(float[] array, int first, int last, 
			    Predicate p)
    {
      int counter = 0;
      while (first < last) 
   ...
   */
  public static int count_if_not(float[] array, int first, int last, 
				 Predicate p)
    {
      int counter = 0;
      while (first < last) 
   ...
   */
  public static int mismatch(float[] array1, float[] array2,
   ...
   *                 index exists.
   */
  public static int search(float[] array1, float[] array2,
