...
public final class Modification
{
   ...
   */
  static public void copy(double[] source, double[] destination,
   ...
   */
  static public void swap_ranges(double[] array1, double[] array2,
   ...
   *                    input range.
   */
  public static void transform(double[] source, double[] destination,
			       int first, int last, int to,
			       UnaryOperator f)
    {
      while (first < last)
   ...
   *                    input range.
   */
  public static void transform(double[] source1, double[] source2,
			       double[] destination,
   ...
   */
  public static void replace(double[] array, int first, int last,
   ...
   */
  public static void replace_if(double[] array, int first, int last,
				Predicate p, double new_value)
    {
      while (first < last) {
   ...
   * @param new_value   Value that old_value will be replaced with.
   */
  public static void replace_copy(double[] source, double[] destination,
				  int first, int last, int to,
				  double old_value, double new_value)
    {
      while (first < last) {
   ...
   * @param new_value   Value to be substituted for replaced elements.
   */
  public static void replace_copy_if(double[] source, double[] destination,
				     int first, int last, int to,
				     Predicate p, double new_value)
    {
      while (first < last) {
   ...
   */
  public static void fill(double[] array, int first, int last, 
			  double x)
    {
      while(first < last) 
	array[first++] = x;
   ...
   */
  public static void generate(double[] array, int first, int last,
			      Generator f)
    {
      while(first < last) 
	array[first++] = f.apply();
   ...
   */
  public static int remove_if(double[] array, int first, int last, 
			      double x)
    {
      int oldLast = last;
      --first;
   ...
   *                 are contained in the range <code>[first, i)</code>.
   */
  public static int stable_remove(double[] array, int first, int last, 
				  double x)
    {
   ...
   *                 are contained in the range <code>[first, i)</code>.
   */
  public static int stable_remove_if(double[] array, int first, int last, 
				     Predicate p)
    {
   ...
   *                    is <code>[to, i)</code>.
   */
  static public int remove_copy(double[] source, double[] destination,
				int first, int last, int to,
				double value)
    {
      while (first < last) {
   ...
   *                    is <code>[to, i)</code>.
   */
  static public int remove_copy_if(double[] source, double[] destination,
				   int first, int last, int to,
				   Predicate p)
    {
      while (first < last) {
   ...
   *                    is <code>[to, i)</code>.
   */
  public static int unique_copy(double[] source, double[] destination,
				int first, int last, int to)
    {
      if (first >= last)
	return to;
   ...
   *                   is invalid.
   */
  static public void reverse(double[] array, int first, int last)
    {
      while (first < --last) {
   ...
   */
  public static void reverse_copy(double[] source, double[] destination,
				  int first, int last, int to)
    {
      while (last > first)
   ...
   * @param last     One past the end of the range
   */
  public static void rotate(double[] array, int first, int middle, 
				 int last)
    {
   ...
   * @param to       First element of the output range
   */
  public static void rotate_copy(double[] source, double[] destination,
   ...
   * @see   Predicate         
   */
  public static int partition(double[] array, int first, int last, 
			      Predicate p)
    {
      --first;
      while (true) {
   ...
   * @see   Predicate         
   */
  public static int stable_partition(double[] array, int first, 
