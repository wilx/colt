...
public final class Sorting
{
   ...
   * @see Sorting#sort
   */
  public static void insertion_sort(double[] array, int first, int last)
    {
      for (int current = first; ++current < last; ) { 
	double tmp = array[current];
	int i = current;
	for (double tmp1 = array[i - 1]; tmp < tmp1; 
	     tmp1 = array[--i - 1] ) {
	  array[i] = tmp1;
	  if (first == i - 1) {
	    --i;
  ...
  private  static int quickPartition(double[] array, int first, int last)
    {
      double f = array[first];
      double l = array[last - 1];
      double pivot = array[first + (last - first) / 2];
  ...
  private static void qsortLoop(double[] array, int first, int last)
    {
   ...
   * @see Sorting#sort
   */
  public static void stable_sort(double[] array, int first, int last)
    {
   ...
   * @see Sorting#sort
   */   
  public static void partial_sort(double[] array, int first, int middle, 
				  int last)
    {
   ...
   * @see Sorting#sort
   */   
  public static void partial_sort(double[] array,
   ...
   * @see Sorting#partial_sort
   */
  public static int partial_sort_copy(double[] source, double[] destination,
				      int first, int last,
	...
	if (source[first] < destination[result_first]) {
	  destination[result_first] = source[first];
	  adjust_heap(destination, result_first, result_first, result_last);
	}
   ...
   * @param last        One past the end of the range.
   */
  public static void nth_element(double[] array, int first, int nth, 
				 int last)
    {
      while (last - first > 3) {
	int cut = quickPartition(array, first, last);
   ...
   * @param comp        Comparison function.
   */
  public static void nth_element(double[] array,
   ...
   */
  public static int lower_bound(double[] array, int first, int last,
				double x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#binary_search
   */
  public static int upper_bound(double[] array, int first, int last,
				double x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#binary_search
   */
  public static Range equal_range(double[] array, int first, int last,
				  double x)
    {
      int len = last - first;
      while (len > 0) {
   ...
   * @see Sorting#equal_range
   */
  public static boolean binary_search(double[] array, int first, int last, 
				      double x)
    {
      int i = lower_bound(array, first, last, x);
      return i < last && !(x < array[i]);
    }
   ...
   * @param return      One past the end of the output range, that is,
   *                    <code>to + (last1-first1) + (last2-first2)</code>.
   * @see Sorting#inplace_merge
   */
  public static int merge(double[] source1, double[] source2, double[] dest,
			  int first1, int last1, int first2, int last2,
			  int to)
    {
      while (first1 < last1 && first2 < last2)
	if (source2[first2] < source1[first1])
   ...
   * @see Sorting#merge
   */
  public static void inplace_merge(double[] array, 
				   int first, int middle, int last)
    {
   ...
   */
  public static boolean includes(double[] array1, double[] array2,
				 int first1, int last1, int first2, int last2)
    {
      while (first1 < last1 && first2 < last2) {
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_union(double[] source1, double[] source2,
			      double[] destination,
			      int first1, int last1, int first2, int last2,
			      int to)
    {
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_intersection(double[] source1, double[] source2,
				     double[] destination,
   ...
   * @see Sorting#set_symmetric_difference
   */ 
  public static int set_difference(double[] source1, double[] source2,
				   double[] destination,
				   int first1, int last1,
				   int first2, int last2,
				   int to)
   ...
   * @see Sorting#set_difference
   */ 
  public static int set_symmetric_difference(double[] source1,
					     double[] source2,
					     double[] destination,
					     int first1, int last1,
					     int first2, int last2,
   ...
   */
  public static void push_heap(double[] array, int first, int last)
    {
      if (last - first < 2) return;
      double tmp = array[--last];
   ...
   * @see Sorting#make_heap
   */
  private static void adjust_heap(double[] array,
   ...
   * @see Sorting#make_heap
   */
  public static void pop_heap(double[] array, int first, int last)
    {
      if (last - first < 2) return;
      double tmp = array[--last];
   ...
   */
  public static void make_heap(double[] array, int first, int last)
    {
      if (last - first < 2) return;
   ...
   * @see Sorting#make_heap
   */
  public static void sort_heap(double[] array, int first, int last)
    {
      while (last - first > 1) {
	double tmp = array[--last];
	array[last] = array[first];
   ...
   */
  public static int max_element(double[] array, int first, int last)
    {
   ...
   */
  public static int min_element(double[] array, int first, int last)
    {
      if (first >= last) return last;
   ...
   */
  public static boolean lexicographical_compare(double[] array1,
						double[] array2,
						int first1, int last1,
						int first2, int last2)
    {
	...
	if (array1[first1] < array2[first2])
	  return true;
	else if (array2[first2++] < array1[first1++])
	  return false;
   ...
   */
  public static boolean next_permutation(double[] array, int first, int last)
    {
      if (last - first < 2)
	return false;
 ...
 /** 
   ...
   */
  public static boolean prev_permutation(double[] array, int first, int last)
    {
      if (last - first < 2)
	return false;
