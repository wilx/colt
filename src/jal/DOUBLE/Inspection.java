package jal.DOUBLE;
import jal.DOUBLE.VoidFunction;
...
final public class Inspection     
{
   ...
   */
  public static void for_each(double[] array, int first, int last,
			      VoidFunction f)
    {
      while(first < last)
	f.apply(array[first++]);
   ...
   */
  public static int adjacent_find(double[] array, int first, int last)
    {
      int next = first;
      while (++next < last) {
   ...
   *                 element exists.
   */
  public static int find(double[] array, int first, int last, double x)
    {
   ...
   *                 element exists.
   */
  public static int find_not(double[] array, int first, int last, double x)
    {
      while (first < last && x == array[first])
	++first;
      return first;
   ...
   *                 element exists.
   */
  public static int find_if(double[] array, int first, int last, 
			    Predicate p)
    {
   ...
   */
  public static int find_if_not(double[] array, int first, int last, 
			      Predicate p)
    {
      while (first < last && p.apply(array[first]))
	++first;
   ...
   */
  public static int count_if(double[] array, int first, int last, 
			    Predicate p)
    {
      int counter = 0;
      while (first < last) 
   ...
   */
  public static int count_if_not(double[] array, int first, int last, 
				 Predicate p)
    {
      int counter = 0;
      while (first < last) 
   ...
   */
  public static int mismatch(double[] array1, double[] array2,
   ...
   *                 index exists.
   */
  public static int search(double[] array1, double[] array2,
