 ...
 */
public Object clone() {
	Ranlux copy = (Ranlux) super.clone();
	copy.iseeds = (int[]) this.iseeds.clone();
	copy.isdext = (int[]) this.isdext.clone();
	copy.next = (int[]) this.next.clone();
	copy.seeds = (float[]) this.seeds.clone();
	return copy;
}
...
public final double raw() { // _WH_ changed (float) xxx -> xxxf
