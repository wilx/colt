 ...
 */
public Object clone() {
	RandomShuffle copy = (RandomShuffle) super.clone();
	copy.generatorA = (RandomElement) this.generatorA.clone();
	copy.generatorB = (RandomElement) this.generatorB.clone();
	copy.deck = (double[]) this.deck.clone();
	return copy;
}
/**
* The generator.
