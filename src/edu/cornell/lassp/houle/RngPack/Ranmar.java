...
* <A HREF="http://nhse.npac.syr.edu:8015/nhse-rw/catalog/random/RANMAR.html"> More info </A>.
* 
* 
* <P>
 ...
 */
public Object clone() {
	Ranmar copy = (Ranmar) super.clone();
	copy.u = (double[]) this.u.clone();
	copy.uvec = (double[]) this.uvec.clone();
	return copy;
}
/**
*
