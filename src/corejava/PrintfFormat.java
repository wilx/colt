  ...
  private class ConversionSpecification {
    ...
    private char[] fFormatDigits(double x) {
      ...
      if (p<-expon+n2In) {
        i = p+n1In-1;
        if (i<ca3.length&&
        (ca3[i]=='5'||ca3[i]=='6'||ca3[i]=='7'
        ||ca3[i]=='8'||ca3[i]=='9')) carry=true;
        i--;
        for (; carry && i>=0; i--) {
          carry = false;
          switch(ca3[i]) {
          case '0': ca3[i]='1'; break;
          case '1': ca3[i]='2'; break;
          case '2': ca3[i]='3'; break;
          case '3': ca3[i]='4'; break;
          case '4': ca3[i]='5'; break;
          case '5': ca3[i]='6'; break;
          case '6': ca3[i]='7'; break;
          case '7': ca3[i]='8'; break;
          case '8': ca3[i]='9'; break;
          case '9': ca3[i]='0'; carry=true; break;
          }
        }
      }
      if (n1In+expon<=0) {
    ...
    private char[] eFormatDigits(double x,char eChar) {
      ...
      if (i0+p<ca1.length-1) {
        if (ca1[i0+p+1]=='5'
        ||ca1[i0+p+1]=='6'||ca1[i0+p+1]=='7'
        ||ca1[i0+p+1]=='8'||ca1[i0+p+1]=='9')
          carry=true;
        for (i=i0+p; carry && i>=i0; i--) {
          carry = false;
          switch(ca1[i]) {
          case '0': ca1[i]='1'; break;
          case '1': ca1[i]='2'; break;
          case '2': ca1[i]='3'; break;
          case '3': ca1[i]='4'; break;
          case '4': ca1[i]='5'; break;
          case '5': ca1[i]='6'; break;
          case '6': ca1[i]='7'; break;
          case '7': ca1[i]='8'; break;
          case '8': ca1[i]='9'; break;
          case '9': ca1[i]='0'; carry=true; break;
          }
        }
        if (carry) {
          ca2 = new char[i0+p+1];
