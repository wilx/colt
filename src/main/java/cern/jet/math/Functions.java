...
public class Functions {
	...
	*/
	 ...
	 */
	public static final DoubleFunction abs = Math::abs;
	...
	*/		
	 ...
	 */
	public static final DoubleFunction ceil = Math::ceil;
	...
	*/		
	 ...
	 */
	public static final DoubleFunction exp = Math::exp;
	...
	*/		
	 ...
	 */
	public static final DoubleFunction identity = a -> a;
	
	/**
	 * Function that returns <tt>1.0 / a</tt>.
	 */
	public static final DoubleFunction inv = a -> 1.0 / a;
	...
	*/		
	 ...
	 */
	public static final DoubleFunction neg = a -> -a;
		
	/**
	 * Function that returns <tt>Math.rint(a)</tt>.
	 */
	public static final DoubleFunction rint = Math::rint;
		
	/**
	 * Function that returns <tt>a < 0 ? -1 : a > 0 ? 1 : 0</tt>.
	 */
	public static final DoubleFunction sign = a -> a < 0 ? -1 : a > 0 ? 1 : 0;
	...
	*/		
	 ...
	 */
	public static final DoubleFunction sqrt = Math::sqrt;
		
	/**
	 * Function that returns <tt>a * a</tt>.
	 */
	public static final DoubleFunction square = a -> a * a;
	...
	*/
	 ...
	 */
	public static final DoubleDoubleFunction compare = Double::compare;
		
	/**
	 * Function that returns <tt>a / b</tt>.
	 */
	public static final DoubleDoubleFunction div = (a, b) -> a / b;
		
	/**
	 * Function that returns <tt>a == b ? 1 : 0</tt>.
	 */
	public static final DoubleDoubleFunction equals = (a, b) -> a == b ? 1 : 0;
		
	/**
	 * Function that returns <tt>a > b ? 1 : 0</tt>.
	 */
	public static final DoubleDoubleFunction greater = (a, b) -> a > b ? 1 : 0;
		
	/**
	 * Function that returns <tt>Math.IEEEremainder(a,b)</tt>.
	 */
	public static final DoubleDoubleFunction IEEEremainder = Math::IEEEremainder;

	/**
	 * Function that returns <tt>a == b</tt>.
	 */
	public static final DoubleDoubleProcedure isEqual = (a, b) -> a == b;

	/**
	 * Function that returns <tt>a < b</tt>.
	 */
	public static final DoubleDoubleProcedure isLess = (a, b) -> a < b;

	/**
	 * Function that returns <tt>a > b</tt>.
	 */
	public static final DoubleDoubleProcedure isGreater = (a, b) -> a > b;

	/**
	 * Function that returns <tt>a < b ? 1 : 0</tt>.
	 */
	public static final DoubleDoubleFunction less = (a, b) -> a < b ? 1 : 0;
		
	/**
	 * Function that returns <tt>Math.log(a) / Math.log(b)</tt>.
	 */
	public static final DoubleDoubleFunction lg = (a, b) -> Math.log(a) / Math.log(b);

	/**
	 * Function that returns <tt>Math.max(a,b)</tt>.
	 */
	public static final DoubleDoubleFunction max = Math::max;
		
	/**
	 * Function that returns <tt>Math.min(a,b)</tt>.
	 */
	public static final DoubleDoubleFunction min = Math::min;
	...
	*/
	 ...
	 * Function that returns <tt>a % b</tt>.
	 */
	public static final DoubleDoubleFunction mod = (a, b) -> a % b;
		
	/**
	 * Function that returns <tt>a * b</tt>.
	 */
	public static final DoubleDoubleFunction mult = (a, b) -> a * b;
	...
	*/
	 ...
	 */
	public static final DoubleDoubleFunction plusAbs = (a, b) -> Math.abs(a) + Math.abs(b);
	
	/**
	 * Function that returns <tt>Math.pow(a,b)</tt>.
	 */
	public static final DoubleDoubleFunction pow = Math::pow;
/**
...
public static void demo1() {
	...
	System.out.println(f.apply(a,b));
	DoubleDoubleFunction g = (x, y) -> Math.sin(x) + Math.pow(Math.cos(y),2);
	System.out.println(g.apply(a,b));
...
public static void demo2(int size) {
	...
	DoubleDoubleFunction g = (x, y) -> Math.abs(Math.sin(x) + Math.pow(Math.cos(y),2));
	System.out.println(g.apply(a,b));
...
public static DoubleFunction IEEEremainder(final double b) {
	return a -> Math.IEEEremainder(a,b);
}
/**
...
public static DoubleFunction round(final double precision) {
	return a -> Math.rint(a/precision)*precision;
}
/**
