...
*/
public abstract class AbstractByteList extends AbstractList<Byte> {
	/**
 ...
 */
@Override
public void replaceFromWith(int from, java.util.Collection<? extends Byte> other) {
	checkRange(from,size());
	Iterator<? extends Byte> e = other.iterator();
	int index=from;
...
public java.util.ArrayList<Byte> toList() {
	int mySize = size();
	java.util.ArrayList<Byte> list = new java.util.ArrayList<>(mySize);
