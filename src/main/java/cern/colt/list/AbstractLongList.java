...
*/
public abstract class AbstractLongList extends AbstractList<Long> {
	/**
 ...
 */
@Override
public void replaceFromWith(int from, java.util.Collection<? extends Long> other) {
	checkRange(from,size());
	Iterator<? extends Long> e = other.iterator();
	int index=from;
...
public java.util.ArrayList<Long> toList() {
	int mySize = size();
	java.util.ArrayList<Long> list = new java.util.ArrayList<>(mySize);
