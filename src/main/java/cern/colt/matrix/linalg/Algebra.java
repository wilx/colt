...
public DoubleMatrix2D permuteRows(final DoubleMatrix2D A, int[] indexes, int[] work) {
	...
	*/
	...
	cern.colt.Swapper swapper = (a, b) -> A.viewRow(a).swap(A.viewRow(b));
...
public String toString(DoubleMatrix2D matrix) {
	...
	cern.colt.function.IntComparator comp = (a, b) -> Property.get(names,a).compareTo(Property.get(names,b));
	cern.colt.Swapper swapper = (a, b) -> {
    Object tmp;
